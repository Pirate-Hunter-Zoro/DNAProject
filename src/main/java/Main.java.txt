...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Reader readerNeedle = new Reader(new SolverNeedlemanWunsch(), "DNA_query.txt", "DNA_sequences.txt");
        ...
        Reader readerLCS = new Reader(new SolverLCS(),  "DNA_query.txt", "DNA_sequences.txt");
        ...
        Reader readerSubstring = new Reader(new SolverSubstring(),  "DNA_query.txt", "DNA_sequences.txt");
